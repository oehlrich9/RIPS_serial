...
class RadioServer {
    ...
    registerSocket() {
		socketProvider.registerSocket(this.radioConfig, this.handleMessage);
    }
    ...
    sendMessageToUDP(line) {
        socketProvider.sendMessageToUDP(line, this.radioConfig.port_inbound, this.radioConfig.ip_host);
    }
